...
router.get("/account", authController.isLoggedIn, userController.showAccount);
...
router.get(
  "/account/reset/:token",
  catchErrors(authController.resetPasswordForm)
);
router.post(
  "/account/reset/:token",
...
router.post(
  ...
  catchErrors(storeController.favoriteStore)
);
