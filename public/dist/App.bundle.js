...
function ajaxFavorite(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    var isFavorited = _this.heart.classList.toggle('heart__button--hearted');
    (0, _bling.$)('.heart-count').textContent = res.data.favorites.length;

    if (isFavorited) {
      _this.heart.classList.add('heart__button--float');
      setTimeout(function () {
        _this.heart.classList.remove('heart__button--float'), 2500;
      });
    }
  }).catch(function (e) {
...
var _es6Promisify = __webpack_require__(35);
...
var getUserCurrentCoords = function getUserCurrentCoords() {
  var coords = {};
...
var handleSearchBarNavigation = function handleSearchBarNavigation(e, search) {
  ...
  if (e.keyCode === 40 && current) {
    ...
    // For first DOWN press
    next = items[0];
  } else if (e.keyCode === 38 && current) {
    // For UP presses after the first
...
module.exports = function () {
    ...
    return __webpack_require__(36).Promise;
}();
...
module.exports = function () {
    ...
    var ES6Promise = __webpack_require__(34);
...
var _favorite = __webpack_require__(12);
...
var favoriteForms = (0, _bling.$$)('form.heart');
favoriteForms.on('submit', _favorite2.default);
